...
zorklike.terminal.main = function(input, terminal) {
...
zorklike.commands.help = function(arguments, terminal) {
...
zorklike.commands.look = function(arguments, terminal) {
	if (arguments.length === 0) {
...
zorklike.commands.go = function(arguments, terminal) {
	if (arguments.length === 0) {
...
zorklike.terminal.write = function(string, terminal) {
...
zorklike.terminal.scroll = function() {
